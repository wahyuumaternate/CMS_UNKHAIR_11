@extends('backend.layouts.main', ['title' => 'Create Gallery']) @section('body')
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <small class="form-text text-muted">Preview:
                                        http://ultranews.test/galleries/your-permalink</small>
                                </div>
    ...
    <script>
        ...
        function openDescriptionModal(inputDesc) {
            selectedDescriptionInput = inputDesc;
            document.getElementById("imageDescription").value = inputDesc.value || "";
